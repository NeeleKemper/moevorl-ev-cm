...
seed = 1
scenario = 'scenario_CS15'
project_name = f'Tune_DDPG_{scenario}'
...
def train():
    ...
    agent.train(
        ...
        eval_freq=100000,
        early_stopping_freq=100000,
        reset_num_timesteps=False,
        save_file_name='DDPG-Tune',
    )
...
def main():
    wandb.login(key="0db6c8bb5a3865cbf8d313c4b9d9c611a1609438")
    sweep_count = 20
