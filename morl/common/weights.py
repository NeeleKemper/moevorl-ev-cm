...
from pymoo.util.reference_direction import get_partition_closest_to_points, get_number_of_uniform_points
...
# def equally_spaced_weights_uniform(dim: int, n: int, seed: int = 42) -> List[np.ndarray]:
#     n_partition = get_partition_closest_to_points(n, dim)
#  n = get_number_of_uniform_points(n_partition, dim)
#  return list(get_reference_directions("uniform", n_dim=dim, n_points=n, n_partition=n_partition, seed=seed))
